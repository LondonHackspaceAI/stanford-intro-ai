...
(TEST
 ...
 > (treesearch* links 'Lugoj 'Sibiu)
 (369 (Lugoj Timisoara Arad Sibiu))
 > (treesearch* links 'Mehadia 'Sibiu)
 (421 (Mehadia Drobeta Craiova RimnicuVilcea Sibiu))
 > (treesearch* links 'Mehadia 'Fagaras)
 (520 (Mehadia Drobeta Craiova RimnicuVilcea Sibiu Fagaras))
 > (treesearch* links 'Drobeta 'Neamt)
 (765 (Drobeta Craiova Pitesti Bucharest Urziceni Vaslui Iasi Neamt)))
